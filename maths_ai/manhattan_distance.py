def calculate_manhattan_distance(dimensions, coord1, coord2):
    """
    Calculates the Manhattan distance between two points in 1D, 2D, or 3D space.
    ...
    if dimensions == 1:
        ...
        return abs(coord2[0] - coord1[0]) + abs(coord2[1] - coord1[1]) + abs(coord2[2] - coord1[2])
    else:
...
def main():
    """
    Main function to prompt the user for input, calculate the Manhattan distance,
    ...
    distance = calculate_manhattan_distance(dimensions, coord1, coord2)
